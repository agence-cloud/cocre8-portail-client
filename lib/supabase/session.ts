 ...
 *
 * `/auth/confirmer` et `/connexion/mot-de-passe` y ont figuré, tant que
 * l'accès d'un client passait par un lien reçu par email. Ce chemin a été
 * retiré : le coach lui donne son mot de passe, le client se connecte par le
 * formulaire comme tout le monde.
 *
